    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-xs-5 text-right m-b-30">
                ...
                <a href="{{URL::route('Position.edit', ['id' => $position->id]) }}" class="btn btn-primary rounded "><i class="fa fa-plus"></i>
                    {{__('pages.position.details.edit')}}
                </a>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        @isset($position->info->sex)<div class="staff-id">{{__('pages.position.details.sex')}} : {{$position->info->birth =='women' ? __('pages.position.details.women') : __('pages.position.details.man')}}</div>@endisset
                                        @isset($position->info->birth)<div class="staff-id">{{__('pages.position.details.birth')}} : {{$position->info->birth}}</div>@endisset
                                        @isset($position->info->cin)<div class="staff-id">{{__('pages.position.details.cin')}} : {{$position->info->cin}}</div>@endisset
                                    ...
                                    <ul class="personal-info">
                                        @isset($position->info->tels[0]->tel)
                                            <li>
                                                ...
                                                <span class="text"><a href="#">{{$position->info->tels[0]->tel}}</a></span>
                                            </li>
                                        @endisset
                                ...
                                <div class="card-box project-box">
                                    <div class="dropdown profile-action">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="{{URL::route('Position.edit',['id'=>$position->id])}}" data-toggle="modal" data-target="#edit_project"><i class="fa fa-pencil m-r-5"></i> Edit___</a></li>
