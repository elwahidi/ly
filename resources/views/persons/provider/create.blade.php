@extends("layouts.app")
@section('title')
    {{__('pages.provider.title_create')}}
@stop
@section('content')
    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4 class="page-title">{{__('pages.provider.title_create')}}</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <form action="/Provider" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="city_id" class="select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                    <option value="0">{{__('pages.provider.details.choise_city')}}</option>
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary btn-lg">{{__('pages.provider.details.submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
